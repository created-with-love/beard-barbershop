...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"slider-dremka.js":[function(require,module,exports) {
...
(function () {
  ...
  var getElByAtr = function getElByAtr(listRefs, atr) {
    return _toConsumableArray(listRefs).find(function (el) {
  ...
  var slider = {
    ...
    displayActiveItem: function displayActiveItem() {
      refs.items[this.activeIndex].setAttribute('data-active', '');

      _toConsumableArray(refs.items).filter(function (el) {
    ...
    setActiveItem: function setActiveItem() {
      var prevElem = getElByAtr(refs.items, 'data-active');
      var prevRadio = getElByAtr(refs.radioBtns, 'checked');
    ...
    listingNext: function listingNext() {
    ...
    listingPrev: function listingPrev() {
      this.activeIndex = this.activeIndex - 1;
  ...
  refs.prevBtn.addEventListener('click', slider.listingPrev.bind(slider)); // listner for run slider
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","slider-dremka.js"], null)
//# sourceMappingURL=/slider-dremka.9fa6056b.js.map